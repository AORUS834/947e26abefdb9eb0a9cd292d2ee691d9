// ==UserScript==
// @name         Dungeon Alchemist - Steam Workshop Direct Download
...
(function() {
    ...
    const DA_APPID = '1588530';
    const JSON_URL = 'https://raw.githubusercontent.com/AORUS834/947e26abefdb9eb0a9cd292d2ee691d9/refs/heads/main/DungeonAlchemist.json';
    ...
    function isParalivesPage() {
        ...
        if (url.includes(`appid=${DA_APPID}`) || url.includes(`/app/${DA_APPID}/`)) return true;
        if (document.querySelector(`a[href*="${DA_APPID}"]`) || document.querySelector(`[onclick*="${DA_APPID}"]`)) return true;
        return false;
    }
